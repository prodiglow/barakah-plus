...
const ResetPasswordPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!strongPasswordRegex.test(password)) {
            // We show toast here but ideally the UI block handles it. 
            // However, to block submission if user ignores UI:
        ...
        try {
            ...
            setTimeout(() => navigate("/?login=true"), 2000); // Redirect to Home/Login
        } catch (err: unknown) {
